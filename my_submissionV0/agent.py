...
- memory: Get current state summary (score, moves, recent history, failed actions)
- get_map: See explored locations and connections
- inventory: Check what you're carrying
- get_location: Get your exact current location name
...
- "[No effect]" in the observation means the action did nothing — do not repeat it
