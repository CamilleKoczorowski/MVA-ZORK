...
class AgentMemory:
    ...
    def update(self, location: str, new_location: str, action: str, obs_before: str,
        ...
        # Don't record failures under "Unknown" — multiple distinct rooms share
        # this key, causing bans to bleed across unrelated locations.
        if is_failed and not location.startswith("Unknown"):
