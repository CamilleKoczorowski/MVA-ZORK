...
class StudentAgent:
    ...
    def _maybe_queue_sweep(self, location: str) -> None:
        """
        V5: On first visit to a named room, queue N/S/E/W that haven't already
        been tried. This guarantees immediate corridor discovery without waiting
        for the LLM to think of it.
        Only fires for named rooms (not Unknown), once per room.
        """
